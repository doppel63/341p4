...
# DVE full session
# Saved on Sun Nov 10 20:57:25 2013
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{304 369} {1573 980}}
...
gui_sg_addsignal -group ${Group1} { top.snd.crc_out top.snd.cs top.snd.crc_in top.snd.clk top.snd.rst top.snd.en }
...
catch { gui_list_select -id ${Data.1} {top.snd.en }}
gui_view_scroll -id ${Data.1} -vertical -set 104
...
gui_open_source -id ${Source.1}  -replace -active top /afs/ece.cmu.edu/usr/xianglin/Private/18341/p4/crc16.sv
