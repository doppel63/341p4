...
# DVE full session
# Saved on Sun Nov 10 21:03:07 2013
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{312 399} {1580 1009}}
...
gui_sg_addsignal -group ${Group1} { top.snd.clk top.snd.rst top.snd.en top.snd.crc_out top.snd.cs }
