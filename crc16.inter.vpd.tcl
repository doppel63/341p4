...
# DVE full session
# Saved on Sun Nov 10 19:21:13 2013
# Designs open: 1
#   Sim: simv
...
#<Session mode="Full" path="/afs/ece.cmu.edu/usr/xianglin/Private/18341/p4/crc16.inter.vpd.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{262 401} {1535 1016}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1273} {height 160} {dock_state bottom} {dock_on_new_line true}}
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{0 22} {1919 1039}}
...
gui_sg_addsignal -group ${Group1} { top.snd.clk top.snd.rst top.snd.en top.snd.msg_in top.snd.msg_out top.snd.crc_out top.snd.cnt top.snd.rem_cnt top.snd.cs }
gui_set_radix -radix {decimal} -signals {Sim:top.snd.cnt}
gui_set_radix -radix {unsigned} -signals {Sim:top.snd.cnt}
...
catch {gui_list_select -id ${Hier.1} {top.snd}}
...
gui_list_show_data -id ${Data.1} {top.snd}
gui_show_window -window ${Data.1}
catch { gui_list_select -id ${Data.1} {top.snd.cs }}
gui_view_scroll -id ${Data.1} -vertical -set 105
...
gui_open_source -id ${Source.1}  -replace -active top crc16.sv
gui_view_scroll -id ${Source.1} -vertical -set 77
...
gui_wv_zoom_timerange -id ${Wave.1} 445 890
...
gui_marker_move -id ${Wave.1} {C1} 705
